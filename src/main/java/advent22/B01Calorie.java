...
public class B01Calorie {

    public static void main(String[] args) {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(
                B01Calorie.class.getResourceAsStream("b01input.txt")))) {

            B01Calorie calorie = new B01Calorie();
            calorie.findTop3Calories(reader);
    ...
    private void findTop3Calories(BufferedReader br) throws IOException {
        ...
        int actual;
        String bests = "part 2: Maximal calories: ";
        set.descendingSet();

        actual = set.pollLast();
        System.out.println("\npart 1: Maximális kalóriaösszeg: " + actual);
        sum = actual;
        bests = bests + Integer.toString(actual) + "; ";
        ...
        actual = set.pollLast();
        sum += actual;
        bests = bests + Integer.toString(actual) + "; The total amount: " + Integer.toString(sum);
...
//Maximal calories: 74394; 69863; 68579; The total amount: 212836